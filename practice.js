...
function both(arr1, arr2) {
  ...
  arr1.forEach(function(element) {
    arr2.includes(element) ? newArray.push(element) : null;
  })
  return newArray;
}
...
users.forEach(function(element) {
  element.email == 'tylermcginnis33@gmail.com' ? users.splice(element, 1) : null;
})
